...
import { ArrowRight, CheckCircle2, ShieldCheck, Truck, PackageCheck } from 'lucide-react';
  ...
  return (
    <section className="relative bg-gray-50 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/3">
        <div className="w-[600px] h-[600px] bg-orange-100/50 rounded-full blur-3xl opacity-60"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-[1.15] tracking-tight mb-6">
              Leading Dehydrated <br className="hidden md:block"/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-orange-500">
                Vegetable & Fruit Powder
              </span> <br className="hidden md:block"/> Supplier in India
            </h1>
            
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-xl">
              From Farm to Factory – We Keep It Fresh. Supplying 100% natural dehydrated powders, spice powders, flakes and granules to food brands across the globe in bulk quantities.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
              <div className="flex flex-col">
                ...
                <span className="text-sm text-gray-500 font-medium">Natural</span>
              </div>
              <div className="flex flex-col">
                <div className="flex items-center text-gray-900 font-bold text-xl mb-1">
                  Zero <ShieldCheck className="w-5 h-5 ml-1 text-blue-500" />
                </div>
                <span className="text-sm text-gray-500 font-medium">Preservatives</span>
              </div>
              <div className="flex flex-col">
                <div className="flex items-center text-gray-900 font-bold text-xl mb-1">
          ...
          <div className="relative lg:ml-auto w-full max-w-lg">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/5] md:aspect-square lg:aspect-[4/5] transform lg:-rotate-2 transition-transform duration-500 hover:rotate-0">
              <img 
                src="https://images.unsplash.com/photo-1596040033229-a9821ebd058d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80" 
                alt="Colorful spices and dehydrated powders"
